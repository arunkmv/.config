...
Org roam server to view roam graph
#+begin_src emacs-lisp
...
* General
Lexical binding to make thing run slightly faster.
#+begin_src emacs-lisp
...
#+end_src
** Org-ref
Require org-ref (no hooks or modes)
#+begin_src emacs-lisp
(require 'org-ref)
#+end_src
...
(map! :map org-mode-map
      ...
      (:prefix ("r" . "org-ref")
       "i" #'org-ref-helm-insert-cite-link
       "a" #'org-zotxt-open-citelink-attachment ))
#+end_src
