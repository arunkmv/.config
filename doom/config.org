...
Org-roam-bibtex for better org-roam integration
#+begin_src emacs-lisp
...
Polymode for markdown syntax highlighting
#+begin_src emacs-lisp
...
(setq org-directory (concat (getenv "HOME") "/Org")
      org_notes-directory (concat org-directory "/notes")
      zotero_bib-file (concat (getenv "HOME") "/Documents/Zotero/references.bib"))
#+end_src
