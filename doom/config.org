...
(org +noter)               ; organize your plain life in plain text
...
** Appearance
#+begin_src emacs-lisp
(setq doom-font (font-spec :family "Source Code Pro" :size 16 :weight 'Regular)
      doom-theme 'doom-gruvbox-mod
      display-line-numbers-type 'relative
      display-time-default-load-average nil)

(add-hook 'doom-after-init-modules-hook #'doom/reload-theme 100)
#+end_src
...
(use-package! beacon
  ...
  :config
  (defun ak/set-beacon-theme-color-h ()
    "Set the beacon theme color to orange according to current theme"
    (setq beacon-color (doom-color 'orange)))
  (add-hook! 'doom-load-theme-hook :append
            #'ak/set-beacon-theme-color-h))
#+end_src
...
#+begin_src emacs-lisp
(after! (vterm ivy)
  (defcustom ak/vterm-ivy-zsh-history-file "~/.config/zsh/.zsh_history"
