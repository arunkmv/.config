;; doom-gruvbox-mod-theme.el --- inspired by morhetz Gruvbox -*- lexical-binding: t; no-byte-compile: t; -*-
(require 'doom-themes)
...
;;
(def-doom-theme doom-gruvbox-mod
  "Modified dark theme with pastel 'retro groove' colors."
  ...
  ((bg
   ...
   (doc-comments   (doom-lighten dark-green 0.2))
   (constants      orange)
   (functions      violet)
   (keywords       red)
   (methods        violet)
  ...
  ((button :foreground cyan :underline t :weight 'bold)
   ...
   ((outline-3 &override) :foreground (doom-darken violet 0.1))
   ((outline-4 &override) :foreground (doom-lighten dark-blue 0.2))
   ((outline-5 &override) :foreground (doom-lighten dark-cyan 0.2))
   ((outline-6 &override) :foreground (doom-lighten dark-green 0.2))
...
;;; doom-gruvbox-mod-theme.el ends here
