...
*** Functions
A few convinence functions for using persp-mode.
...
#+begin_src emacs-lisp
  (use-package git-gutter-fringe
    :defer t
    :config
    (set-face-foreground 'git-gutter-fr:modified (modus-themes-color 'yellow-faint))
    (set-face-foreground 'git-gutter-fr:added    (modus-themes-color 'green-faint))
    (set-face-foreground 'git-gutter-fr:deleted  (modus-themes-color 'red-faint))
